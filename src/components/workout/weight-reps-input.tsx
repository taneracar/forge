    ...
    <View className="min-w-0 flex-1 gap-1.5">
      ...
      <View className="min-w-0 flex-row items-center gap-1.5">
        <Pressable
          ...
          className="h-10 w-10 shrink-0 items-center justify-center rounded-md border border-border"
          hitSlop={4}
        >
          <Minus color={Colors.foreground} size={14} />
        </Pressable>
        <TextInput
          className="min-w-0 flex-1 rounded-md border border-border bg-surface px-2 py-2.5 text-center text-base text-foreground"
